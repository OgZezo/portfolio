  ...
  return (
    <main className="min-h-screen bg-bg-escuro text-white flex flex-col overflow-hidden">
      ...
      >
        ...
        >
          &lt;/<span className="text-[#FBD15B]">Grupo Opus</span>&gt;
        </h1>
      </header>
      ...
      <section className="flex-1 w-full flex flex-col items-center pb-24">
        ...
        >
          <div className="w-full bg-[#B6A477] border-4 border-[#121211] rounded-3xl shadow-2xl flex items-center justify-center overflow-hidden">
            <img src={`/projeto3_img/projeto3_landingpage.jpg`} alt="grupo-opus" className="w-full h-auto object-cover" />
          </div>
        </div>
        ...
        <FadeIn>
          <div className="w-full max-w-4xl mx-auto px-6 md:px-8 flex flex-col gap-10 text-lg md:text-xl text-zinc-300 leading-relaxed text-justify md:text-left font-body">
            <p>
              ...
              Landing page para o <span style={{ color: "#FBD15B", fontWeight: 700 }}>Grupo Opus</span>, um grupo empresarial, focado em solucionar a vida de seus clientes e suas empresas. O design do site é moderno, utilizando uma paleta de cores elegantes e elementos visuais para destacar a identidade do grupo. A página apresenta seções sobre as áreas de atuação do grupo, contatos e uma apresentação de um serviço de qualidade, tudo otimizado e pensado para se ter uma navegação fluida, responsiva e acessível.
            </p>
          </div>
        </FadeIn>
      </section>
